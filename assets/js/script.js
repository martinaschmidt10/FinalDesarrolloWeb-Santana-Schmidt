...
document.addEventListener('DOMContentLoaded', function () {
    ...
    /* -----------------------------------------------------------
       9b. MENÚ DESPLEGABLE DE NOTIFICACIONES
       Mismo patrón que el menú de perfil (#9): toggle al hacer click,
       cierre al hacer click afuera, y cierra el menú de perfil si
       estaba abierto (y viceversa) para que no convivan los dos.
    ----------------------------------------------------------- */
    ...
    // También hacemos que el menú de perfil cierre el de notificaciones
    // cuando se abre (lo enganchamos al listener que ya existe arriba).
    if (toggleMenuPerfil && menuPerfil) {
